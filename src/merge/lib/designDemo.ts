...
const DEMO_COMPOSITION: DemoCompositionAsset[] = (
  [
    ...
    ["SOL", "Solana", 0.2, 158.42, 34.1, 74_500_000_000, 6.2, 2_100_000_000],
    ["JUP", "Jupiter", 0.13, 0.92, 18.6, 2_480_000_000, 3.1, 88_000_000],
    ["JTO", "Jito", 0.1, 3.41, -7.2, 1_150_000_000, -1.8, 46_000_000],
    ["RAY", "Raydium", 0.09, 4.85, 22.9, 1_320_000_000, 4.4, 61_000_000],
    ["PYTH", "Pyth Network", 0.09, 0.38, -12.4, 1_390_000_000, -2.6, 52_000_000],
    ["BONK", "Bonk", 0.08, 0.0000214, 41.7, 1_580_000_000, 9.8, 210_000_000],
    ["WIF", "dogwifhat", 0.07, 2.06, 9.3, 2_060_000_000, 2.2, 145_000_000],
    ["ORCA", "Orca", 0.06, 3.12, 14.2, 985_000_000, 1.9, 31_000_000],
    ["HNT", "Helium", 0.05, 7.84, -4.6, 1_400_000_000, -0.8, 24_000_000],
    ["RENDER", "Render", 0.05, 6.95, 11.3, 2_700_000_000, 3.6, 96_000_000],
    ["TNSR", "Tensor", 0.04, 0.51, -9.1, 210_000_000, -2.3, 12_000_000],
    ["W", "Wormhole", 0.04, 0.28, 5.4, 830_000_000, 1.1, 44_000_000],
  ] as const
