...
import { calcHoldingValue, calcUnrealizedPnl, calcUnrealizedPnlPct, calcPortfolioValue, formatUsdc, SSR_PRICE_USDC, SOL_PRICE_USDC } from "@/lib/calculations";
import { Card, CardContent, CardHeader, CardTitle, CardDescription } from "@/components/ui/card";
import { Table, TableBody, TableCell, TableHead, TableHeader, TableRow } from "@/components/ui/table";
import { Button } from "@/components/ui/button";
import { Link } from "wouter";
import { Wallet, PieChart, ArrowUpRight, ArrowDownRight, Search } from "lucide-react";
                      ...
                      <TableRow key={holding.dtrId} className="border-border/50 hover:bg-muted/20">
                        ...
                        <TableCell className="text-right">
                          <div className={`flex flex-col items-end ${isProfit ? 'text-primary' : 'text-destructive'}`}>
                            ...
                            <span className="font-merge-mono text-xs flex items-center">
