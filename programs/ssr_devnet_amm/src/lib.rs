...
pub mod ssr_devnet_amm {
    ...
    pub fn initialize_amm_config(ctx: Context<InitializeAmmConfig>, hub_mint: Pubkey, default_fee_bps: u16) -> Result<()> {
        instructions::initialize_amm_config::handler(ctx, hub_mint, default_fee_bps)
    }
