// POST /api/devnet/reserve-image -- stores a Reserve's profile picture
...
// `${window.location.origin}/api/devnet/reserve-image?id=<id>` in the
...
// api/mainnet/reserve-image.ts (same lib/reserve-image/payload.ts
...
//
// GET /api/devnet/reserve-image?id=<id> -- serves the stored image bytes
