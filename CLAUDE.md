...
- **Co-Manager** = a wallet the Reserve's root Manager has granted scoped, revocable management permissions on that Reserve (**final, as of 2026-09-07, DEC-0185**). "Co-manager" (lowercase, hyphenated in prose; "Co-Manager"/"Co-Managers" in titles, labels, and headings) is the only approved word for this role everywhere a human reads it: UI copy, tooltips, toasts, legal pages, docs, the journey map, the architecture map, and the road-to-mainnet checklist. **"Delegate" must never appear in user-facing product copy or documentation prose for this role.** The Create Reserve step formerly titled "Additional Managers" is titled "Co-Managers".
